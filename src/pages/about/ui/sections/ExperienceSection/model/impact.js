export const EXPERIENCE_IMPACT = {
  kiberpride: {
    ...
    outcomes: ["Faster diagnostics", "Predictable environment", "Clear daily reporting"],
  },
  colezium: {
    metrics: ["Remote support", "Ticket flow", "User recovery"],
    outcomes: ["Resolved client issues", "Cleaner escalation", "Actionable reports"],
  },
}

export const getExperienceImpact = (id) => {
  return EXPERIENCE_IMPACT[id] || {
