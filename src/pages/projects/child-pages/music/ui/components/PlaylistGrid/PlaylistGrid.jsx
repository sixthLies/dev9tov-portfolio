            ...
            <div className="playlist-card__now-playing" aria-label="Now playing">
              <svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14">
                ...
                <rect x="10.5" y="10" width="3" height="10" rx="1">
                  <animate attributeName="height" values="10;4;10" dur="0.8s" repeatCount="indefinite" begin="0.2s" />
                  <animate attributeName="y" values="10;16;10" dur="0.8s" repeatCount="indefinite" begin="0.2s" />
                </rect>
                <rect x="17" y="12" width="3" height="8" rx="1">
                  <animate attributeName="height" values="8;14;8" dur="0.8s" repeatCount="indefinite" begin="0.4s" />
                  <animate attributeName="y" values="12;6;12" dur="0.8s" repeatCount="indefinite" begin="0.4s" />
                </rect>
              </svg>
